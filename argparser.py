...
def argparser():
    ...
    parser.add_argument('--lr', type=float, default='0.01', help='learning rate for training e.g 0.01')
    ...
    parser.add_argument('--classifier',type=str, help='Which fitted classifier to use. LR|SGD', default='lr')
    parser.add_argument('--fit_score', type=int, default='0', help='Which fitted energy to use for docking')
